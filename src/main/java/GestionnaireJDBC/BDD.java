...
public abstract class BDD {
    ...
    public static void Bdd()  {
        ...
        try {
            connection = DriverManager.getConnection("jdbc:derby:memory:"+Bdd+";create=true");
            connection.close();
    ...
    public static Connection Connect() {
        try {
            return DriverManager.getConnection("jdbc:derby:memory:"+Bdd+";create=false");
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return null;
     ...
     */
    public static void resetBddTables(String NameTable, List<String> attribut) throws Exception {
        Connection connection = BDD.Connect();
        //BDD.SupprimerTables(connection);
        BDD.CreateTableFigure(connection, NameTable, attribut);
     ...
     * @throws SQLException en cas d'erreur de creation
     */
    private static void CreateTableFigure(Connection connection, String NameTable, List<String> attribut)throws SQLException {
    	Map<String, String > map = new HashMap<String, String>();
    	map.put(attributsOfFile.NOM.get(), attributsOfFile.NOM.get()+" varchar(50) primary key,");
    	map.put(attributsOfFile.TYPE.get(), attributsOfFile.TYPE.get()+" varchar(50),");
    	map.put(attributsOfFile.SIZE.get(), attributsOfFile.SIZE.get()+" int,");
    	map.put(attributsOfFile.ACCESRIGHTS.get(), attributsOfFile.ACCESRIGHTS.get()+" varchar(50),");
    	map.put(attributsOfFile.DATELACCES.get(), attributsOfFile.DATELACCES.get()+" varchar(50),");
    	map.put(attributsOfFile.DATELMODIFICATION.get(), attributsOfFile.DATELMODIFICATION.get()+" varchar(50),");
